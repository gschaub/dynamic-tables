...
export default function Edit(props) {
	...
	function setIsTableResolving(table) {
		console.log('Table Resolving Status - ' + JSON.stringify(table.table))
	...
	const { table = null, tableHasStartedResolving, tableHasFinishedResolving, tableIsResolving } = useSelect((select) => {
		...
		return {
			table: select(tableStore).getTable(table_id, tableStatus),
