...
//    public array $tempBuild = array();
    ...
    public function get_table_data($requestArgs)
    {
 ...
 */
    ...
    public function create_table_data($postId, $tableName, $classes)
    {
    ...
    public function update_table($tableId, $postId, $tableName, $classes)
    {
        $success = 'Processing';
        $updatedRows = 0;
        global $wpdb;
...
// $this->result = array(
//     'success' => $success,
//     'deleted_rows' => $deletedTableRows + $deletedColumnRows + $deletedCellRows);
